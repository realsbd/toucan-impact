...
<div>
    ...
    <div class="content">
        ...
        <b-row>
            <b-col lg="6">
                <!-- Earnings Chart -->
                <base-block rounded title="Impacts" header-bg>
                    <template #options>
            ...
            <b-col lg="6">
                <!-- Sales Chart -->
                <base-block rounded title="Global Goals" header-bg>
                    <template #options>
                        <button type="button" class="btn-block-option">
                            <i class="si si-settings"></i>
                        </button>
        ...
        <b-row class="row-deck">
            <!-- Latest Customers -->
            <b-col xl="6">
                <base-block rounded title="Latest Impacts" header-bg content-full>
                    <template #options>
                        <button type="button" class="btn-block-option">
                            <i class="si si-settings"></i>
                        </button>
                    ...
                    <b-table-simple striped hover borderless class="table-vcenter font-size-sm mb-0">
                        <b-thead>
                            <b-tr>
                                ...
                                <b-th class="d-none d-lg-table-cell font-w700 text-center">Action Date </b-th>
                                <b-th class="font-w700">Action by</b-th>
                                <b-th class="d-none d-sm-table-cell font-w700 text-center">Action type</b-th>
            ...
            <!-- Latest Orders -->
            <b-col xl="6">
                <base-block rounded title="Latest Global Goals" header-bg content-full>
                    <template #options>
                        <button type="button" class="btn-block-option">
                            <i class="si si-settings"></i>
                        </button>
                    ...
                    <b-table-simple striped hover borderless class="table-vcenter font-size-sm mb-0">
                        <b-thead>
                            <b-tr>
                                <b-th class="font-w700" style="width: 80px;">ID</b-th>
                                <b-th class="d-none d-lg-table-cell font-w700 text-center">Label</b-th>
                                <b-th class="font-w700">Link</b-th>
                                <b-th class="font-w700 text-center" style="width: 60px;"></b-th>
                            </b-tr>
                        </b-thead>
                        <b-tbody>
