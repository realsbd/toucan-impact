                        ...
                        <b-form @submit.stop.prevent="onSubmit">
                            <div class="py-3">
                                ...
                                <div class="form-group">
                                    <b-form-input size="lg" class="form-control-alt" id="first_name" name="first_name" placeholder="first name" v-model="$v.form.first_name.$model" :state="!$v.form.first_name.$error && null" aria-describedby="first_name-feedback"></b-form-input>
                                    <b-form-invalid-feedback id="first_name-feedback">
                                        Please enter a first name
                                    </b-form-invalid-feedback>
                                </div>
                                <div class="form-group">
                                    <b-form-input size="lg" class="form-control-alt" id="last_name" name="last_name" placeholder="last name" v-model="$v.form.last_name.$model" :state="!$v.form.last_name.$error && null" aria-describedby="last_name-feedback"></b-form-input>
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-if="email_exist" class="text-danger text-small">
    ...
    methods: {
        onSubmit() {
            ...
            this.$store
                ...
                .catch(err => (console.log(err), this.email_exist = true))
